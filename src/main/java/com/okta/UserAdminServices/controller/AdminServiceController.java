...
public class AdminServiceController {
	...
	public String assignAppToUser(@RequestParam String userId, @RequestParam String appId) throws IOException {		
		return assignUsersToApplication.assignUsersToApplication(userId, appId);
	}
	
	@GetMapping("/revokeUser")
	public String revokeUserFromApp(@RequestParam String userId, @RequestParam String appId) throws IOException {		
